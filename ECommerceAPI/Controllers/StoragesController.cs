...
namespace ECommerceAPI.Controllers
{
    ...
    public class StoragesController : ControllerBase
    {
        ...
        public StoragesController(ECommerceContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("StorageName{name}")]
        public async Task<ActionResult<List<Storage>>> GetStorage(string name)
        {
            var storage = await (from i in _context.Storages where i.StorageName.ToLower()==name.ToLower() select i).ToListAsync();
